    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }} edges={["top"]}>
      <ScrollView contentContainerStyle={{ padding: space.lg, paddingBottom: 80 }}>
        ...
        <View style={{ marginTop: space.lg }}>
          ...
          <MenuRow testID="menu-extrato" icon="document-text-outline" label="Extrato mensal (SLA & valores)" color="#EC4899" onPress={() => router.push("/(app)/extrato")} />
        ...
        <Text style={styles.versionInfo}>Valeteck • v12 — Logística reversa completa</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
